    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        if ($request->input('submit')== 'magic-link'){
            ...
            if(!$user){
                return redirect()->route('login')->withErrors(['email' => 'User with this email doesn\'t exist'])
                    ->withInput();
            }
            return redirect()->route('login')->withMessage('link sent successfully to your email ' . $user->email);
        }
